...
public class testcovid {
    void affiche() {
        ...
        if (reponse == "o") {
            ...
            System.out.println(" Avez-vous une toux récente ou une toux chronique aggravée depuis peu? \n");
            reponse = scan.nextLine();

        if (reponse == "o") {
            symptome1 = symptome1 + 1;
        }
        System.out.println(" Avez-vous de la difficulté à respirer ou êtes-vous essoufflé? \n");
        reponse = scan.nextLine();
        if (reponse == "o") {
            symptome1 = symptome1 + 1;
        }
        System.out.println(" Avez-vous un mal de gorge? \n");
        reponse = scan.nextLine();
        if (reponse == "o") {
            symptome1 = symptome1 + 1;
        }
        if (symptome1 != 0){System.out.println("\n VEILLEZ VOUS RETIRER IMEDIATEMENT DE VOTRE TRAVAIL \n");}
        System.out.println(
        ...
        System.out.println(" Nausées (maux de cœur) ou vomissements \n");
        reponse = scan.nextLine();
        if (reponse == "o") {
            symptome2 = symptome2 + 1;
        }
        ...
        System.out.println(" Nez qui coule ou congestion nasale (nez bouché) de cause inconnue \n");
        reponse = scan.nextLine();
        if (reponse == "o") {
            symptome2 = symptome2 + 1;
        }
        System.out.println("Fatigue intense inhabituelle sans raison évidente \n");
        reponse = scan.nextLine();
        if (reponse == "o") {
            symptome2 = symptome2 + 1;
        }
        System.out.println(" Perte d’appétit importante \n");
        reponse = scan.nextLine();
        if (reponse == "o") {
            symptome2 = symptome2 + 1;
        }
        ...
        System.out.println(" Mal de tête inhabituel \n");
        reponse = scan.nextLine();
        if (reponse == "o") {
            symptome2 = symptome2 + 1;
        }
        if (symptome2 >= 2){System.out.println("\n VEILLEZ VOUS RETIRER IMEDIATEMENT DE VOTRE TRAVAIL \n");}
        System.out.println("\n\n ________________________________________EXPLICATIONS________________________________________ \n\n");
        ...
        if (reponse == "o") {
            ...
            System.out.println("Êtes-vous cas contact?  : 'o' pour oui ou 'n' pour non ");
            reponse = scan.nextLine();
            if (reponse == "o") {
                System.out.println(
                ...
                System.out.println("Je veux faire un test pour… // 'o' pour oui ou 'n' pour non \n");
                reponse = scan.nextLine();
                if (reponse == "o") {
                    System.out.println(
